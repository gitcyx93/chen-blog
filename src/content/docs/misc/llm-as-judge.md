...
Prompt 书写灵感可以参考 [MixEval](https://link.zhihu.com/?target=https%3A//github.com/huggingface/lighteval/blob/main/src/lighteval/tasks/extended/mix_eval/judge_prompts.pyy) 或 [MTBench](https://link.zhihu.com/?target=https%3A//github.com/huggingface/lighteval/blob/main/src/lighteval/tasks/extended/mt_bench/judge_prompt_templates.py) 的 prompt 模板。

其他要点:

- 成对比较比对输出评分[更能反映人类的偏好](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/2403.16950)，且通常更稳健
- 如果任务确实需要对输出评分为具体的值，建议使用整数，并详细解释 [每个分值的代表含义](https://link.zhihu.com/?target=https%3A//x.com/seungonekim/status/1749289437165769177)，或添加说明 prompt `如 provide 1 point for this characteristic of the answer, 1 additional point if ... (回答具备某项特性得 1 分，如果 ... 再加 1 分)` 等
...
- \*\*\*思维链 (CoT)\*\*：要求模型 **在评分之前** 给出推理过程，可以 [提高准确性](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/2212.08073) (参考这篇 [帖子](https://link.zhihu.com/?target=https%3A//x.com/seungonekim/status/1749289437165769177))。
- **多轮分析**：可以更好地 [检测事实性错误](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/2305.13281)
- **陪审团机制**：汇总多个评价模型的结果 [比单一模型的结果更好](https://link.zhihu.com/?target=https%3A//arxiv.org/abs/2404.18796)。
